import type { IRenderingStrategy, RenderingConfig } from '@/rendering/interfaces/IRenderingStrategy'
...
export class RenderingContext {
  ...
  getHoveredTile(x: number, y: number, tiles: Tile[], config: RenderingConfig): number | null {
